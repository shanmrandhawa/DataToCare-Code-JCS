...
def calculate_results(conn, pset, predictions):
    ...
    print('calculating metric of Accuracy with respect to patients average (precision, recall, F1-score) for testing proportional experiment.')
    ...
    print('calculating metric of Accuracy with respect to treatments (accumulated F1-score) for testing proportional experiment.')

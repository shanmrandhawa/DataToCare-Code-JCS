...
def start():
    print("Pipeline started for evaluating strategy of Uniform-umap-accumulated (UUA).")
...
def stop(conn, cur):
    ...
    print("Pipeline ended for evaluating strategy of Uniform-umap-accumulated (UUA).")

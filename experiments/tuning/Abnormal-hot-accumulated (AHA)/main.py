...
def start():
    print("Pipeline started for evaluating strategy of Abnormal-hot-accumulated (AHA).")
...
def stop(conn, cur):
    ...
    print("Pipeline ended for evaluating strategy of Abnormal-hot-accumulated (AHA).")

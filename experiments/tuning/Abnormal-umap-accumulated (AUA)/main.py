...
def start():
    print("Pipeline started for evaluating strategy of Abnormal-umap-accumulated (AUA).")
...
def stop(conn, cur):
    ...
    print("Pipeline ended for evaluating strategy of Abnormal-umap-accumulated (AUA).")

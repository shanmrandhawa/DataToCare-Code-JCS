...
def start():
    print("Pipeline started for evaluating strategy of Abnormal-umap-instantaneous (AUI).")
...
def stop(conn, cur):
    ...
    print("Pipeline ended for for evaluating strategy of Abnormal-umap-instantaneous (AUI).")
